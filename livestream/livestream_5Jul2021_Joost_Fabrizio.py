...
# %%
myctrl = MyATSChannelController_livestream(name='my_controller', alazar_name='Alazar',qdac = qdac_OX)
# %%
...
myctrl.int_time(28e-3)
myctrl.int_delay()

chan4.num_averages(1)
chan4.records_per_buffer(30)
chan4.alazar_channel('B')
